...
const BarangayOfficials = () => {
  return (
    <>
      ...
      <div className="barangayPage">
        <h1 className="barangayOfficials p-16-semibold flex size-full gap-4 p-4 group font-semibold focus:bg-gradient-to-r from-gray-400 to-gray-600 focus:text-white text-gray-700 transition-all ease-linear">
          Barangay Officials Member
        </h1>
        <div className="barangayData">
          <section
          ...
          >
            ...
            <div
              className="barangayMembers relative overflow-x-scroll overflow-y-scroll shadow-md"
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td
                      ...
                      style={{ fontSize: "14.5px", fontWeight: "bold" }}
                    >
                      Zone 7 Sta.Monica ashd ioudgasjbdisa ugdsa
                      dhgasidasdugasdagsudygasudygasoiduasgdaosd
                    </td>
                    <td
                      className="px-6 py-4 text-black"
                      style={{ fontSize: "14.5px", fontWeight: "bold" }}
