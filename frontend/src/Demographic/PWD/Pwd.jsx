...
const Pwd = () => {
  return (
    <>
      <div>
        <div className="prsn">
          <h1 className="dsblts p-16-semibold flex size-full gap-4 p-4 group font-semibold focus:bg-gradient-to-r from-gray-400 to-gray-600 focus:text-white text-gray-700 transition-all ease-linear">
            PWD's
          </h1>
          <div className="back">
            <Link to="/homepage">
