  ...
  return (
    <>
      ...
      <div className="residentPage">
        <h1 className="residentRecords p-16-semibold flex size-full gap-4 p-4 group font-semibold focus:bg-gradient-to-r from-gray-400 to-gray-600 focus:text-white text-gray-700 transition-all ease-linear">
          Resident Records
        </h1>
        <div className="residentData">
          ...
          >
            ...
            <div
              className="residents relative overflow-x-scroll overflow-y-scroll shadow-md"
